...
(function() {
    ...
    AudioSettingsUI.prototype.createUI = function() {
                ...
                <div class="settings-card-body">
                    ...
                    <div class="audio-setting-item">
                        ...
                        <div class="audio-select-control">
                            ...
                            <button type="button" id="voiceTestButton" class="btn btn-primary audio-test-btn" style="margin-left: 8px;">
                                <span>🗣️</span> <span data-i18n="audio.notification.testVoice">測試語音</span>
                            </button>
                        </div>
                    </div>
        ...
        this.voiceTestButton = this.container.querySelector('#voiceTestButton');
    ...
    AudioSettingsUI.prototype.setupEventListeners = function() {
        ...
        // 測試語音事件
        if (this.voiceTestButton) {
            this.voiceTestButton.addEventListener('click', function() {
                self.audioManager.speak('你好，我是云舒。這是語音測試。Hello, I am Yunshu.');
            });
        }
    ...
    AudioSettingsUI.prototype.updateControlsState = function() {
        ...
        // 語音測試按鈕也受啟用狀態控制
        if (this.voiceTestButton) {
            this.voiceTestButton.disabled = !enabled;
        }
    };
